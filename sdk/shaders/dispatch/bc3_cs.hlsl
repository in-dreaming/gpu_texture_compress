// dispatch/bc3_cs.hlsl - Compute shader entry point for BC3 compression
// Dispatches one thread per 4x4 block, loads RGBA pixels from SourceTexture,
// calls pure compress_bc3() function.

#include "common/gtc_interface.hlsl"
#include "compress/bc3.hlsl"
...
void MainCS(uint3 DTid : SV_DispatchThreadID) {
    ...
    OutputBlocks[blockIndex] = compress_bc3(pixels);
}
