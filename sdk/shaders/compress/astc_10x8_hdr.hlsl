#ifndef ASTC_10x8_HDR_HLSL
#define ASTC_10x8_HDR_HLSL

//=============================================================================
// ASTC 10x8 HDR Compression
// 80 pixels -> 4x4 weight grid
//=============================================================================
...
uint4 compress_astc_10x8_hdr(float4 pixels[80])
{
    float max_hdr_val = 0.0;
    [unroll] for (int i = 0; i < 80; i++) {
