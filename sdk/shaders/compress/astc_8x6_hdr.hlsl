#ifndef ASTC_8x6_HDR_HLSL
#define ASTC_8x6_HDR_HLSL

//=============================================================================
// ASTC 8x6 HDR Compression
// 48 pixels -> 4x4 weight grid
//=============================================================================
...
uint4 compress_astc_8x6_hdr(float4 pixels[48])
{
    float max_hdr_val = 0.0;
    [unroll] for (int i = 0; i < 48; i++) {
